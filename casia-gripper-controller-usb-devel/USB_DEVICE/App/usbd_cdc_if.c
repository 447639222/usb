...
//this function is to check the application buffer whether has data
uint8_t* Main_loop(void)
{
    ...
    if (UserTxBufPtrOut != UserTxBufPtrIn)
    {
        ...
        CDC_Transmit_FS((uint8_t*) (UserTxBufferFS + UserTxBufPtrOut),
                buffsize);
    ...
    return (UserTxBufferFS + UserTxBufPtrOut);
}
